...
https://github.com/grigoriev/alfred-network-workflow/security/advisories/new
...
Vulnerabilities in upstream software (Alfred, the macOS network tools, `jq`) belong to the upstream project. Tell us as well

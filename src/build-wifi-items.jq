# Format a scan (array of { section, ssid, channel, security, rssi }) into Alfred
# Wi-Fi items, sorted by priority and signal. Args: --argjson saved, --arg prefix,
# --argjson high/medium/low, --arg active/star/open/lock/end (icon prefixes).
def strength(r):
  if r == null then 4
  elif r < -80 then 1
  elif r < -70 then 2
